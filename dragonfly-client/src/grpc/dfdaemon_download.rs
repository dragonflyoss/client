...
use dragonfly_client_util::{
    ...
    id_generator::{PersistentCacheTaskIDParameter, PersistentTaskIDParameter},
    ratelimiter::bbr::BBR,
    shutdown,
    types::redacted::RedactedDownloadPersistentTaskRequest,
};
...
impl DfdaemonDownload for DfdaemonDownloadServerHandler {
    ...
    async fn download_task(
        ...
        // Download the task by the task manager and return the stream of the
        // download progress.
